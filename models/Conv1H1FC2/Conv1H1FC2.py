"""Conv1H1FC2 Concrete cracking classification model"""
...
class Conv1H1FC2(nn.Module):
    ...
    def __init__(self,
        ...
        '''
        super(Conv1H1FC2, self).__init__()
        ...
        hidden_fc1 = nn.Linear(in_features=4,
                               out_features=hidden_layer_sizes[0],
                               bias=True)
        self.hidden_fc_layers.append(hidden_fc1)
...
def train_and_test():
    ...
    parser.add_argument(
        '--output_path',
        default=
        '/home/wongjames/cs230/Project/saved_models_12_2_2022/Conv1H1FC2.pt',
